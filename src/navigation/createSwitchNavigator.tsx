...
export const createSwitchNavigator = <ParamList extends Record<string, object | undefined>>(): TypedNavigator<
  ...
  React.ComponentType<DefaultNavigatorOptions<ParamList, StackNavigationState<ParamList>, StackNavigationOptions, StackNavigationEventMap> & StackRouterOptions & StackNavigationConfig>
> => {
  ...
  return {
    ...
    Navigator: (props) => {
      ...
      return <StackView {...(props as any)} {...stackViewProps} />;
    },
  };
};
